...
UserGQLModel = typing.Annotated["UserGQLModel", strawberry.lazy("GraphTypeDefinitions.externals")]
GroupGQLModel = typing.Annotated["GroupGQLModel", strawberry.lazy("GraphTypeDefinitions.externals")]
...
RBACObjectGQLModel = typing.Annotated["RBACObjectGQLModel", strawberry.lazy("GraphTypeDefinitions.externals")]
@strawberry.field(description="""Who made last change""")
