...
from gql_externalids.GraphPermissions import OnlyForAuthentized
@strawberry.field(
    description="Retrieves the externalid",
...
class ExternalIdInsertGQLModel:
    inner_id: UUID = strawberry.field(default=None, description="Primary key of entity which new outerid is assigned")
