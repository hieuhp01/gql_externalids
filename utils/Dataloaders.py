...
def createLoaders_3(asyncSessionMaker, models=dbModels) -> Loaders:
    ...
    class Loaders:
        ...
        @property
        @cache
        def externalids_inner_id(self): return createFkeyLoader(asyncSessionMaker, ExternalIdModel, foreignKeyName="inner_id")
...
def createLoadersContext(asyncSessionMaker):
    return {
        "loaders": createLoaders_3(asyncSessionMaker)
    }
